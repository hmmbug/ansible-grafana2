...
Requirements
------------
Currently the [`grafana repo`](http://docs.grafana.org/installation/) is not automatically installed by this role and will need to be installed first.
...
The [`grafana repo`](http://docs.grafana.org/installation/) must be installed first.
